...
if __name__ == '__main__':
    ...
    report_dir = report_util.make_report_dir()
    ...
    # Evasion Attacks.
        ...
        if args.evasion_method == 'all':
            ...
            adv_path_list.append(utility.save_adv_npz('fgsm', X_adv_fgsm, report_dir))
            ...
            adv_path_list.append(utility.save_adv_npz('cnw', X_adv_cnw, report_dir))
            ...
            adv_path_list.append(utility.save_adv_npz('jsma', X_adv_jsma, report_dir))
